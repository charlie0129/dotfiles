...
echo -n "==>  5: "; printpath "System Settings" "Soptlight" "Search Privacy... (Bottom of Page)" "Add /Library, /Users, /Volumes"; echo " (Spotlight is a resource hog. I just use Spotlight (Alfred) to launch apps, so do not index anything other than apps.)"
echo -n "==>  6: "; printpath "System Settings" "Notifications" "Allow notifications when the display is sleeping" "OFF"; echo " (avoid constantly waking screen)"
echo -n "==>  7: "; printpath "System Settings" "Notifications" "Allow notifications when the screen is locked" "OFF"; echo " (Macs are not as personal as an iPhone, avoid leaking information when you are away)"
echo -n "==>  8: "; printpath "System Settings" "Notifications" "Allow notifications when mirroring or sharing the display" "OFF"; echo " (you don't want notifications to show up on a projector or TV)"
echo -n "==>  9: "; printpath "System Settings" "Privacy & Security" "(Scroll to the bottom)" "Allow applications from" "Anywhere"; echo " (do not let macOS decide what is safe or not, you are the one who decides)"
echo -n "==> 10: "; printpath "System Settings" "Privacy & Security" "(Scroll to the bottom)" "Accessories" "Automatically allow when unlocked"; echo " (do not make me confirm every time I plug in a USB device)"
