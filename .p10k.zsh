# Generated by Powerlevel10k configuration wizard on 2020-10-18 at 21:22 CST.
...
# dark-ornaments, compact, many icons, concise, instant_prompt=auto-off.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=247 #232
  ...
  typeset -g POWERLEVEL9K_STATUS_VERBOSE_SIGNAME=true #modified
